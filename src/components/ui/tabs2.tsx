...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "bg-opacity-0 relative mt-0 no-visible-scrollbar flex w-full max-w-max flex-row items-center justify-start overflow-auto border-x border-t perspective-[1000px] sm:overflow-visible",
          containerClassName,
        )}
      >
