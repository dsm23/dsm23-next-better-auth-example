...
export default async function Page() {
  ...
  return (
    <div className="no-visible-scrollbar flex min-h-[80vh] items-center justify-center overflow-hidden">
      <main className="row-start-2 flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col gap-1">
          <h3 className="text-center text-3xl text-black sm:text-4xl dark:text-white">
            BETTER-AUTH.
          </h3>
